#!/usr/bin/env python3
"""Small Odysseus scoped API helper for Claw terminal sessions."""
...
def _config() -> tuple[str, str] | None:
    ...
    if missing:
        print(f"missing {', '.join(missing)}; create a Claw Agent token in Odysseus Settings", file=sys.stderr)
        return None
